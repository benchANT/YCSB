 ...
 */
public abstract class TelegrafDB extends DB implements TelegrafDbIfc {

  protected static boolean doDebug = false;

  protected static void debug(String prefix, Object any) {
    if(doDebug) {
      System.err.println(prefix + any.toString());
    }
  }
  ...
  public void init() {
      ...
      doDebug = Boolean.parseBoolean(props.getProperty("debug", "false"));
  }
   ...
   * @return The result of the operation.
   */
  public final Status update(String table, String key, Map<String, ByteIterator> values) {
    return Status.NOT_IMPLEMENTED;
  }
